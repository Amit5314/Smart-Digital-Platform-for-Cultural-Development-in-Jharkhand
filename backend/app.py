...
# PLACES = [
#     {"id":1, "name":"Netarhat", "type":"nature"},
#     {"id":2, "name":"Betla National Park", "type":"wildlife"},
#     {"id":3, "name":"Hundru Falls", "type":"nature"},
#     {"id":4, "name":"Deoghar", "type":"culture"}
# ]
...
#     matched = [p for p in PLACES if interest in p['type']]
#     if not matched: matched = PLACES

#     plan = {"days": days, "plan": []}
#     for d in range(1, days+1):
#         place = matched[(d-1) % len(matched)]
#         plan['plan'].append({
#             'day': d,
#             'place': place['name'],
#             'activities': ['sightseeing','local market'],
#             'estimate_cost': random.randint(500,2000)
#         })
#     return jsonify(plan)
...
#         reply = 'Netarhat is famous for sunrise points and plateaus.'
#     else:
#         reply = 'I can help with itineraries, crafts, and guides.'
